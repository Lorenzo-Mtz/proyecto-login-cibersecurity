...
*Última actualización: Septiembre 2026 — se amplía 4.6 Endurecimiento OWASP con los términos de MFA/TOTP (Fase 2, WBS 4.3); antes, con los de recuperación de contraseña (WBS 4.2) y fuerza bruta (WBS 4.1). Las secciones 4.1 – 4.5 se completaron durante la Fase 0 (temas 0.2 a 0.6).*
