...
| M1 | Fase 1 completa: autenticación básica robusta funcional |
| M2 | Fase 2 completa: endurecimiento (MFA, prevención OWASP Top 10, logging) |
| M4 | Cierre del proyecto: Lessons Learned Log completo, glosario finalizado |
...
- Alcance no bien definido ("calidad de mercado") puede generar scope creep si no se controla contra los criterios de la sección 3
...
| Equipo de ejecución / Execution team | Lorenzo Mtz + Claude (asistente de planeación y aprendizaje) |
...
**Fecha:** Agosto 2026(Se detallan a fondo en el Risk Register — aquí solo los más relevantes a nivel charter)
| M3 | Fase 3 (stretch): checklist ASVS Level 1 documentado + threat model básico |
| Hito | Entregable |
